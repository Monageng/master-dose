...
//		Parent root = loader.load(); 
  ...
  private void showMainView(String sessionID) {
    try {
      ...
      Tab tab2 = new Tab("Configuration"  , new Label("This page is to setup the configuration... Coming Soon"));
      Tab tab3 = new Tab("User Management"  , new Label("Added users and roles... Coming Soon"));
